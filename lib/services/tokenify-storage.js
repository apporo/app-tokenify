...
var CachedEntrypointStore = require('../../ext/entrypoint-cached-store');
var ConfigEntrypointStore = require('../../ext/entrypoint-config-store');
var FileEntrypointStore = require('../../ext/entrypoint-file-store');
var RestEntrypointStore = require('../../ext/entrypoint-rest-store');
