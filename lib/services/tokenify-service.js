...
var Service = function(params) {
  ...
  var verifyHttpAuth = function(req) {
  ...
  self.verifyMIX = function(req, res, next) {
    ...
    self.logger.debug('Start MIX verification - Request[%s]', req.traceRequestId);
    Promise.any([ verifyHttpAuth(req), verifyJWT(req), verifyKST(req) ]).then(function() {
